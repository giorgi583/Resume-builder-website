	...
	return (
		<div className="max-w-4xl mx-auto bg-white text-gray-800">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm ">
					...
					{data.personal_info?.Globe && (
						<a target="_blank" href={data.personal_info?.Globe} className="flex items-center gap-2">
							...
							<span className="break-all text-xs">{data.personal_info.Globe.split("https://")[1] ? data.personal_info.Globe.split("https://")[1] : data.personal_info.Globe}</span>
						</a>
					)}
			...
			<div className="p-8">
				...
				{data.proffessional_summary && (
					<section className="mb-8">
						<h2 className="text-2xl font-light mb-4 pb-2 border-b border-gray-200">
							Professional Summary
						</h2>
						<p className="text-gray-700 ">{data.proffessional_summary}</p>
					</section>
				)}
