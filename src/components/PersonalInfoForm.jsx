...
<label>
    ...
    ) : (<div className='inline-flex items-center gap-2 mt-5 text-slate-600 hover:text-slate-700 cursor-pointer'><User className='size-10 p-2.5 border rounded-full'/>Upload image</div>)}
<input type="file" hidden accept='image/png, image/jpeg' onChange={(e) => handleChange('image', e.target.files[0])}/>
</label>
